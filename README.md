...
👨‍💻 Programmer Analyst with experience in web development, specializing in Java and Python. Has proven skills in creating front-end interfaces using Angular, React, and jQuery, and in implementing back-end architectures with Java and Python. Proficient in a variety of technologies and frameworks, including Spring, Django, Flask, and Node.js. Competent in cloud technologies, such as AWS, GCP, OpenSearch, and DevOps tools, such as Docker, Kubernetes, messaging systems (Kafka), databases (Oracle, PostgreSQL) and unit tests (JUnit, Mockito, Pytest). Contributed significantly to the development and maintenance of robust web applications, including an application that increased the operational efficiency of the company by allowing the validation of new insurance policies.
